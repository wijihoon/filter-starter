...
public class CorsFilter extends OncePerRequestFilter {
    ...
    private boolean areHeadersAllowed(HttpServletRequest request, List<String> allowedHeaders) {
        ...
        List<String> requestHeaders = requestHeaderNames != null ?
                Collections.list(requestHeaderNames).stream().map(String::trim).collect(Collectors.toList()) : Collections.emptyList();
    ...
    private void handleCorsViolation(HttpServletResponse response, ErrorCode errorCode) throws IOException {
        ...
        response.sendError(HttpStatus.FORBIDDEN.value(), ResponseVo.error(errorCode.getMessage(), errorCode.getHttpStatus()).toString());
    }
}
