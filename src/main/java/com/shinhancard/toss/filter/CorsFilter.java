 ...
 * <p>
 * {@link CorsProperties} 클래스로부터 CORS 설정을 주입받아 {@link org.springframework.web.filter.CorsFilter}를 설정합니다.
 * </p>
 */
@Configuration
...
public class CorsFilter {
	...
	/**
	 * CORS 설정을 적용한 {@link org.springframework.web.filter.CorsFilter}를 반환합니다.
	 *
	 * @return CORS 설정이 적용된 {@link org.springframework.web.filter.CorsFilter} 객체
	 */
	@Bean
